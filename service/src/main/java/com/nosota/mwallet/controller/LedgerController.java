...
/**
 * REST controller for low-level ledger operations.
 *
 * <p>Implements {@link LedgerApi} interface for:
 * <ul>
 *   <li>Wallet operations (hold, settle, release, cancel)</li>
 *   <li>Transaction group management</li>
 *   <li>Transfer operations</li>
 *   <li>Balance and transaction queries</li>
 * </ul>
 *
 * <p><b>Note:</b> High-level payment operations are in {@link PaymentController}
 */
@RestController
@Validated
